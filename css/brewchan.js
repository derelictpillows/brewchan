...
function setStylesheet(style) {
    document.cookie = 'brewchan_style=' + style + '; expires=Tue, 19 Jan 2038 03:14:07 UTC; path=/; SameSite=Strict';
...
window.addEventListener('DOMContentLoaded', (event) => {
    var style = getCookie("brewchan_style");
    if (style && style != "") {
        setStylesheet(style);
    }
    ...
    if (newpostpassword) {
        newpostpassword.change(function () {
            ...
            if (newpostpassword) {
                ...
                document.cookie = "brewchan_password=" + encodeURIComponent(newpostpassword.val()) + "; path=/; expires=" + expiration_date.toGMTString();
            }
        });
    }

    var password = getCookie("brewchan_password");
